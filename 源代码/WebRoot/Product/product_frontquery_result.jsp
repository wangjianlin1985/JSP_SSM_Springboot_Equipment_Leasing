			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Product/<%=product.getProductId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=product.getMainPhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		租赁价格:<%=product.getPrice() %>
			     	</div>
			     	<div class="field">
	            		商品库存:<%=product.getProductCount() %>
			     	</div>
			     	<div class="field">
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="product_price_edit" class="col-md-3 text-right">租赁价格:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_price_edit" name="product.price" class="form-control" placeholder="请输入租赁价格">
			 </div>
		  </div>
		  <div class="form-group">
